...
export function WorkflowDefaultLayout(props) {
    ...
    const content = (_jsxs("div", { className: "workflow-with-name-and-metadata", children: [showHeader && (_jsx(EntityHeaderComponent, { isCompact: isHeaderCompact, icon: ENTITY_ICONS.workflow, name: String((_a = entity.name) !== null && _a !== void 0 ? _a : ""), subtitle: {
    ...
    return useHostTheme ? (content) : (_jsx(ThemeProvider, { theme: oldLightMaterialUITheme, children: content }));
}
