...
declare module "@exabyte-io/cove.js/dist/mui/components/tabs/TabsMenu" {
    const TabsMenu: React.ComponentType<any>;
    export default TabsMenu;
}

declare module "@exabyte-io/cove.js/dist/mui/components/icon/entityIcons" {
    export const ENTITY_ICONS: Record<string, string>;
}

declare module "@exabyte-io/cove.js/dist/mui/components/popover/info-popover/InfoPopoverWithDocumentation" {
