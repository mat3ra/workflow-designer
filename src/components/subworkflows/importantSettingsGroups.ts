...
const PROVIDER_TITLES: Record<string, string> = {
    ...
    qgrid: "Q-point Grid",
    qpath: "Q-point Path",
    igrid: "Interpolation Grid",
    ipath: "Interpolation Path",
...
const ENGINE_KEYWORDS: Record<string, string> = {
    ...
    igrid: "igrid interpolation mesh wannier",
    ipath: "ipath interpolation path wannier band",
    explicitKPath: "kpath explicit k-points",
    explicitKPath2PIBA: "kpath explicit k-points 2pi/a cartesian",
